...
set(MSG_I_FLAGS "-Ilimo_base:/home/agilex/nakada_ws/src/limo_ros/limo_base/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/agilex/nakada_ws/src/limo_ros/limo_base/msg/LimoStatus.msg" NAME_WE)
add_custom_target(_limo_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "limo_base" "/home/agilex/nakada_ws/src/limo_ros/limo_base/msg/LimoStatus.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(limo_base
  "/home/agilex/nakada_ws/src/limo_ros/limo_base/msg/LimoStatus.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/limo_base)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/limo_base\")")
  # install generated code
  install(
